...
<body>
	...
	<div style="margin-top: 50px;" id="index_box" class="index_box">
		<span class="list_title">Profile you liked</span>
		<?php
		$req = $bdd->prepare('SELECT DISTINCT users.last_name, users.first_name, users.user_id, users.pic_0 FROM users INNER JOIN likes ON likes.liked_id = users.id WHERE likes.liking_id = ?');
